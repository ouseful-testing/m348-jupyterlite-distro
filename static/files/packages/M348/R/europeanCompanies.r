...
#'
#' The Amadeus data is taken from a database which contains
#' comprehensive information on around 21 million public and private
#' companies across Europe. There are around 21
#' million companies in the database with information on financial
#' indicators, stock prices, directors and many other attributes. The
#' data can be used to explore companies' competitiveness, economic
#' integration, applied microeconomics, business cycles, economic
#' geography and corporate finance. 
#'
