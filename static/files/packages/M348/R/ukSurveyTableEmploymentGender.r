#' Employment and Gender in a Living Costs and Food Survey
#'
#' The data relating to employment and gender from \code{UKSurvey} given in 
#' a tabulated form.
#'
#' @format A data frame with 8 rows and 3 variables:
#' \describe{
#'	\item{count}{the number of household reference people}
...
#'
#' @usage data(ukSurveyEmploymentGender)

"ukSurveyEmploymentGender"
