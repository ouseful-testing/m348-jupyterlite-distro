#' The Olympics 2020 dataset
#'
#' This dataset includes data for the competing nations at Tokyo 2020.
#'
#' @format A data frame with 191 rows and 9 variables:
#' \describe{
